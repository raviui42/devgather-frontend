...
export const Login = () => {
    ...
    const [email, setEmail] = useState("ankamm@gmail.com");
    const [password, setPassword] = useState("Ankam@42");
      ...
      <div className="flex justify-center ">
        <div className="card bg-base-100 w-96 card-bordershadow-sm shadow-lg">
          <div className="card-body gap-y-8">
            <h2 className="card-title flex justify-center font-black text-4xl">Login</h2>
            <div >
              <div>
            ...
            <div className="card-actions justify-center">
              <button className="btn btn-primary text-xl" onClick={loginDetails}>Login</button>
            </div>
          </div>
        </div>
      </div>
